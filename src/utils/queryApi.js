...
// If not keep the content type json and the body will be parse automatically to json
                    config = {
                        ...config,
                        headers: { "Content-Type": "application/json", },
                        data: body,
...
// This example uses localStorage, feel free to change it to cookie storage o something else.
